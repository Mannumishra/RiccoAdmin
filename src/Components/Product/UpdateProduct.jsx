...
function UpdateProduct() {
    ...
    const getApiData = async () => {
        try {
            let res = await axios.get("https://riccobackend.onrender.co/api/product/" + _id)
            console.log(res);
    ...
    const postData = async (e) => {
        ...
        try {
            ...
            const res = await axios.put("https://riccobackend.onrender.co/api/product/" + _id, formData);
            if (res.status === 200) {
